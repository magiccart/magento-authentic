	...
	function _qsJnit(){
		...
		qsHandlerImg.fancybox({
				...
				beforeShow : function(){
			        ...
			        if(Themecfg.detail.slide > 0) quickview.find(".product-image-thumbs").bxSlider({infiniteLoop: true , minSlides: 4, visibleItems: 4, maxSlides: 3, slideMargin: 22, slideWidth: Themecfg.detail.slideWidth, mode: modeSlide, controls: parseInt(Themecfg.detail.controls), pager: parseInt(Themecfg.detail.pager), responsiveBreakpoints : {480: 3, 640: 4, 768: 3, 900: 4}});
